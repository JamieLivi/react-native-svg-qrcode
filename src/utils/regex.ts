...
export const testKanji = (str: string): boolean => TEST_KANJI.test(str);

export const testNumeric = (str: string): boolean => TEST_NUMERIC.test(str);

export const testAlphanumeric = (str: string): boolean => TEST_ALPHANUMERIC.test(str);
